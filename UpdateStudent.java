...
public class UpdateStudent extends JFrame implements ActionListener
{
    ...
    UpdateStudent()
    {
       ...
       JLabel lbrollno=new JLabel("Select Roll No");
        ...
        // choice
        crollno=new Choice();
        crollno.setBounds(290,100,200,25);
        add(crollno);
        ...
        JLabel labelbrollno=new JLabel();
        labelbrollno.setBounds(260,201,200,28);
        labelbrollno.setFont(new Font("serif",Font.BOLD,20));
        add(labelbrollno);
       ...
       JLabel faddhar=new JLabel();
        ...
        try
        {
           ...
           while(rs.next())
           {
               ...
               labelbrollno.setText(rs.getString("rollno"));
